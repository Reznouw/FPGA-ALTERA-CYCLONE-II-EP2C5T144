...
ARCHITECTURE structure OF ejem IS
...
-- Equation(s):
-- \data_out~2_combout\ = (\data_out~1_combout\) # ((\Mux3~1_combout\ & (\ope~combout\ & !\cant_desp~combout\(0))))
...
-- Equation(s):
-- \data_out~8_combout\ = (\cant_desp~combout\(0) & ((\cant_desp~combout\(1) & (\data_in~combout\(3))) # (!\cant_desp~combout\(1) & ((\data_in~combout\(4)))))) # (!\cant_desp~combout\(0) & (((\data_in~combout\(4)))))
...
-- Equation(s):
-- \data_out~9_combout\ = (\data_out~7_combout\) # ((\data_out~8_combout\ & !\ope~combout\))
...
-- Equation(s):
-- \data_out~11_combout\ = (\data_out~10_combout\) # ((!\ope~combout\ & \data_in~combout\(4)))
